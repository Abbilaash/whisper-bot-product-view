...
export default function LeNetPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-4xl font-extrabold text-white tracking-tight mb-2">LeNet5 CNN Visualizer</h1>
      ...
      <h2 className="text-2xl font-bold text-white mt-8 mb-4">LeNet-5 Explainability Output Architecture</h2>
      <div className="border border-white/10 rounded-xl p-4 bg-slate-900/40 text-center my-6 max-w-2xl mx-auto font-sans">
        <img src="/lenet5.png" alt="LeNet-5 Explainability Output Architecture" className="rounded-lg mx-auto max-h-80 object-contain mb-3" />
        <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Interactive CNN Explainability Output</p>
      </div>
    </div>
  );
}
